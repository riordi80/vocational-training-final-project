const Button = ({
  ...
  const variants = {
    primary: "bg-brand-accent hover:bg-brand-primary text-white focus:ring-brand-accent disabled:bg-gray-400",
    ...
    outline: "border-2 border-brand-accent text-brand-accent hover:bg-brand-accent hover:text-white focus:ring-brand-accent disabled:border-gray-300 disabled:text-gray-300"
  };
