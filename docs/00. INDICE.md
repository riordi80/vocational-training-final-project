...
- [Testing Frontend](./TESTING_VITEST.md) - Suite de tests Vitest: setup, comandos, cobertura y guía AAA
...
├── TESTING_VITEST.md                    # Suite de tests frontend: Vitest, mocks, cobertura
