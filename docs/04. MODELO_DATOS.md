...
El sistema gestiona 9 entidades principales:
...
| 4 | **Arbol** | Árboles plantados en los centros educativos | Tabla principal |
...
| 9 | **Notificacion** | Notificaciones enviadas a usuarios sobre alertas | Tabla principal |
...
-- Proyecto Árboles (Proyecto Árboles)
-- ============================================
...
**Nombre**: Proyecto Árboles - Sistema de Monitorización Ambiental en Centros Educativos
