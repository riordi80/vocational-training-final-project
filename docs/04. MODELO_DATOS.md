...
|---|---------|-------------|------|
| 1 | **Usuario** | Usuarios del sistema (Admin, Profesor, Estudiante, Invitado) | Tabla principal |
| 2 | **Rol** | Roles de usuario | Enum/Tabla |
...
classDiagram
    ...
    UsuarioCentro --> RolEnCentro : tiene
...
| `rol` | VARCHAR(20) | NOT NULL, CHECK | Rol: ADMIN, PROFESOR, ESTUDIANTE, INVITADO |
...
**Clave Primaria Compuesta**: `(id, timestamp)`
...
| `rol_en_centro` | VARCHAR(30) | NOT NULL, CHECK | Rol específico en el centro |
...
**Próxima actualización**: Tras implementación de entidades JPA
