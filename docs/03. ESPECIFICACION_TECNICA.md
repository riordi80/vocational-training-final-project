...
**Estado actual**: Todas las fases completadas (1-6) | Proyecto desplegado
...
- [x] Frontend React con estructura completa
- [x] Sistema de autenticación mock (Login/Register)
- [x] Layout responsive con menú hamburguesa
- [x] Componentes comunes reutilizables
- [x] CRUD completo de Árboles en Frontend React
- [x] Consumo de API desde React (axios)
- [x] Formularios con validaciones client-side
- [x] Aplicación Android con 4 actividades
- [x] CRUD de Árboles desde Android
- [x] Conexión Android → Backend API (Render)
- [x] Despliegue en producción (Vercel + Render)
- [x] Documentación completa (manuales de instalación y usuario)

**Futuro (Post 8 diciembre - Opcional):**
- Firmware ESP32 con sensores IoT
- Sistema de alertas y notificaciones
- Visualización de datos en tiempo real desde sensores reales
- Gráficas históricas con TimescaleDB
...
**Estado**: Completado y desplegado en Render
...
│   └── layout/          # Header (con menú hamburguesa), MainLayout, ProtectedRoute
├── pages/
│   ├── login/           # Login.jsx
│   ├── register/        # Register.jsx
│   ├── dashboard/       # Dashboard.jsx
│   ├── arboles/         # ListadoArboles, DetalleArbol, FormularioArbol
│   └── component-library/
├── context/
│   └── AuthContext.jsx  # Autenticación mock + localStorage
├── services/
│   ├── api.js           # Axios configurado
│   ├── arbolesService.js  # CRUD árboles
│   └── centrosService.js  # CRUD centros
└── App.jsx              # React Router configurado
```

**Funcionalidades completadas**:
- [x] React Router Dom con rutas públicas y protegidas
- [x] AuthContext mock (acepta cualquier email/contraseña)
- [x] Persistencia con localStorage
- [x] Header responsive con menú hamburguesa
- [x] Componentes comunes reutilizables (Button, Input, Alert, Spinner)
- [x] Tailwind CSS para estilos responsive
- [x] Axios configurado con interceptors
- [x] CRUD completo de Árboles (listar, crear, editar, eliminar, detalle)
- [x] Formularios con validaciones client-side
- [x] Feedback al usuario (mensajes éxito/error con Alert)
- [x] Mínimo 4 ventanas (Dashboard, ListadoArboles, DetalleArbol, FormularioArbol)
- [x] Consumo real de API REST (arbolesService y centrosService)

#### 2.1.4 Aplicación Móvil Android - COMPLETADO

**Tecnología**: Android SDK 24+ (Android 7.0) + Java

**IDE**: Android Studio

**Estado**: Completado con CRUD funcional
...
├── api/              # RetrofitClient, ArbolApi, AuthInterceptor
└── model/            # Arbol, CentroEducativo
```

**Funcionalidades completadas**:
- [x] Login y Registrer activities (autenticación mock)
- [x] ListarArboles con RecyclerView
- [x] ArbolDetalles con visualización completa
- [x] Retrofit configurado con URL de producción (Render)
- [x] Modo edición en ArbolDetalles
- [x] Funcionalidad eliminar árbol con confirmación
- [x] Datos de sensores simulados (temperatura, humedad, CO2)
- [x] Manejo de errores y fallback a datos locales
- [x] Timeouts de 60 segundos para Render free tier

**Requisitos Fase 5 cumplidos**:
- [x] Mínimo 4 actividades (Login, Registrer, ListarArboles, ArbolDetalles)
- [x] Listar todos los árboles del sistema
- [x] Visualizar detalles con datos de sensores (simulados)
- [x] Modificar datos del árbol (modo edición integrado)
- [x] Eliminar árbol con diálogo de confirmación
