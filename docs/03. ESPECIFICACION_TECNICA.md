...
**Componentes hardware**: Ver `docs/Componentes para ESP32/Componentes.png`
...
- El sistema debe soportar 4 roles: ADMIN, PROFESOR, ESTUDIANTE, INVITADO
...
#### RNF-01: Rendimiento
- El backend debe responder peticiones API en < 500ms (percentil 95)
- El frontend debe cargar la página inicial en < 3 segundos
- La app Android debe iniciar en < 2 segundos
- Las consultas a base de datos deben estar optimizadas con índices

#### RNF-02: Escalabilidad
- El sistema debe soportar al menos 100 centros educativos
- El sistema debe soportar al menos 1000 árboles
- TimescaleDB debe manejar millones de lecturas de sensores
- La arquitectura debe permitir escalado horizontal del backend

#### RNF-03: Disponibilidad
- El sistema en producción debe tener 99% uptime (excluyendo cold starts)
- El sistema debe recuperarse automáticamente de errores transitorios
- El backend debe implementar health checks
...
- El sistema debe prevenir SQL Injection mediante ORM
- El sistema debe prevenir XSS mediante escapado automático
- Las credenciales de BD no deben estar en el código fuente
- Las comunicaciones en producción deben usar HTTPS
